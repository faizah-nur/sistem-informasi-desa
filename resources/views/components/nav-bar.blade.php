  <nav class="fixed top-0 left-0 right-0 z-50 bg-lime-800/40 backdrop-blur-md">
        ...
        <div class="flex items-center ">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/profilDesa" :active="request()->is('profilDesa')">Profil Desa</x-nav-link>
              <x-nav-link href="/kabar" :active="request()->is('kabar')">Kabar</x-nav-link>
              <x-nav-link href="/pengumuman" :active="request()->is('pengumuman')">Pengumuman</x-nav-link>
          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <el-dropdown class="relative ml-3">
              <button class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                ...
                <img src="/img/user.png " alt="" class="size-8 rounded-full outline -outline-offset-1 outline-white/10" />
              </button>

              <el-menu anchor="bottom end" popover class="w-48 origin-top-right rounded-md bg-green-700 py-1 outline-1 -outline-offset-1 outline-white/10 transition transition-discrete [--anchor-gap:--spacing(2)] data-closed:scale-95 data-closed:transform data-closed:opacity-0 data-enter:duration-100 data-enter:ease-out data-leave:duration-75 data-leave:ease-in">
